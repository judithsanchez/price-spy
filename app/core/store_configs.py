...
class StoreConfig:
    ...
    custom_interaction: Callable[[Any, str | None], Coroutine[Any, Any, None]] | None = None
...
register_store(StoreConfig(
    ...
    cookie_click_targets=["#didomi-notice-agree-button", 'button:has-text("Akkoord en sluiten")'],
    cookie_hide_selectors=["#didomi-host"]
))

register_store(StoreConfig(
    domain_keyword="zalando",
    custom_interaction=handle_zalando_interaction
))
