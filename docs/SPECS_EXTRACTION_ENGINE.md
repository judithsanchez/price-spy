## 1. Goal
Reliably capture a visual snapshot of any product or search page and extract structured price data using Gemini 2.5 Flash, while remaining undetected by anti-bot systems.
...
The engine will send the following prompt to Gemini 2.5 Flash along with the screenshot:
