...
INSERT INTO "api_usage" VALUES(87,'gemini-2.5-flash-lite','2026-01-26',12,'2026-01-26T23:41:52.053172+00:00',0);
INSERT INTO "api_usage" VALUES(99,'gemini-2.5-flash-lite','2026-01-27',17,'2026-01-27T23:45:34.666310+00:00',0);
...
INSERT INTO "categories" VALUES(178,'Test','2026-01-27 15:31:29',0);
...
INSERT INTO "error_log" VALUES(5,'unhandled_exception','''Product'' object has no attribute ''current_stock''','http://100.117.106.90:8000/',NULL,'Traceback (most recent call last):
  ...
  File "/usr/local/lib/python3.11/site-packages/fastapi/routing.py", line 243, in run_endpoint_function
    return await dependant.call(**values)
           ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/app/app/api/routers/ui.py", line 103, in dashboard
    "current_stock": product.current_stock,
                     ^^^^^^^^^^^^^^^^^^^^^
  File "/usr/local/lib/python3.11/site-packages/pydantic/main.py", line 1026, in __getattr__
    raise AttributeError(f''{type(self).__name__!r} object has no attribute {item!r}'')
AttributeError: ''Product'' object has no attribute ''current_stock''','2026-01-26 21:51:44');
INSERT INTO "error_log" VALUES(6,'unhandled_exception','''Product'' object has no attribute ''current_stock''','http://100.117.106.90:8000/',NULL,'Traceback (most recent call last):
  File "/usr/local/lib/python3.11/site-packages/starlette/middleware/errors.py", line 164, in __call__
    await self.app(scope, receive, _send)
  File "/usr/local/lib/python3.11/site-packages/starlette/middleware/exceptions.py", line 63, in __call__
    await wrap_app_handling_exceptions(self.app, conn)(scope, receive, send)
  ...
  File "/usr/local/lib/python3.11/site-packages/pydantic/main.py", line 1026, in __getattr__
    raise AttributeError(f''{type(self).__name__!r} object has no attribute {item!r}'')
AttributeError: ''Product'' object has no attribute ''current_stock''','2026-01-26 21:53:48');
INSERT INTO "error_log" VALUES(7,'unhandled_exception','''Product'' object has no attribute ''current_stock''','http://100.117.106.90:8000/',NULL,'Traceback (most recent call last):
  File "/usr/local/lib/python3.11/site-packages/starlette/middleware/errors.py", line 164, in __call__
    await self.app(scope, receive, _send)
  File "/usr/local/lib/python3.11/site-packages/starlette/middleware/exceptions.py", line 63, in __call__
    await wrap_app_handling_exceptions(self.app, conn)(scope, receive, send)
  ...
  File "/usr/local/lib/python3.11/site-packages/pydantic/main.py", line 1026, in __getattr__
    raise AttributeError(f''{type(self).__name__!r} object has no attribute {item!r}'')
AttributeError: ''Product'' object has no attribute ''current_stock''','2026-01-26 22:37:42');
INSERT INTO "error_log" VALUES(8,'unhandled_exception','''Product'' object has no attribute ''current_stock''','http://100.117.106.90:8000/',NULL,'Traceback (most recent call last):
  File "/usr/local/lib/python3.11/site-packages/starlette/middleware/errors.py", line 164, in __call__
    await self.app(scope, receive, _send)
  File "/usr/local/lib/python3.11/site-packages/starlette/middleware/exceptions.py", line 63, in __call__
    await wrap_app_handling_exceptions(self.app, conn)(scope, receive, send)
  ...
  File "/usr/local/lib/python3.11/site-packages/pydantic/main.py", line 1026, in __getattr__
    raise AttributeError(f''{type(self).__name__!r} object has no attribute {item!r}'')
AttributeError: ''Product'' object has no attribute ''current_stock''','2026-01-26 22:40:28');
INSERT INTO "error_log" VALUES(9,'unhandled_exception','''sqlite3.Row'' object has no attribute ''get''','http://100.117.106.90:8000/',NULL,'Traceback (most recent call last):
  File "/usr/local/lib/python3.11/site-packages/starlette/middleware/errors.py", line 164, in __call__
    await self.app(scope, receive, _send)
  File "/usr/local/lib/python3.11/site-packages/starlette/middleware/exceptions.py", line 63, in __call__
    await wrap_app_handling_exceptions(self.app, conn)(scope, receive, send)
  ...
  File "/usr/local/lib/python3.11/site-packages/fastapi/routing.py", line 243, in run_endpoint_function
    return await dependant.call(**values)
           ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/app/app/api/routers/ui.py", line 107, in dashboard
    latest_price_rec = price_repo.get_latest_by_url(item.url)
                       ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/app/app/storage/repositories.py", line 86, in get_latest_by_url
    return self._row_to_record(row)
           ^^^^^^^^^^^^^^^^^^^^^^^^
  File "/app/app/storage/repositories.py", line 113, in _row_to_record
    is_size_matched=bool(row.get("is_size_matched", True)),
                         ^^^^^^^
AttributeError: ''sqlite3.Row'' object has no attribute ''get''','2026-01-27 14:05:35');
INSERT INTO "error_log" VALUES(10,'unhandled_exception','''sqlite3.Row'' object has no attribute ''get''','http://100.117.106.90:8000/',NULL,'Traceback (most recent call last):
  File "/usr/local/lib/python3.11/site-packages/starlette/middleware/errors.py", line 164, in __call__
    await self.app(scope, receive, _send)
  File "/usr/local/lib/python3.11/site-packages/starlette/middleware/exceptions.py", line 63, in __call__
    await wrap_app_handling_exceptions(self.app, conn)(scope, receive, send)
  ...
  File "/app/app/storage/repositories.py", line 113, in _row_to_record
    is_size_matched=bool(row.get("is_size_matched", True)),
                         ^^^^^^^
AttributeError: ''sqlite3.Row'' object has no attribute ''get''','2026-01-27 14:07:19');
INSERT INTO "error_log" VALUES(11,'unhandled_exception','''sqlite3.Row'' object has no attribute ''get''','http://100.117.106.90:8000/',NULL,'Traceback (most recent call last):
  File "/usr/local/lib/python3.11/site-packages/starlette/middleware/errors.py", line 164, in __call__
    await self.app(scope, receive, _send)
  File "/usr/local/lib/python3.11/site-packages/starlette/middleware/exceptions.py", line 63, in __call__
    await wrap_app_handling_exceptions(self.app, conn)(scope, receive, send)
  ...
  File "/app/app/storage/repositories.py", line 113, in _row_to_record
    is_size_matched=bool(row.get("is_size_matched", True)),
                         ^^^^^^^
AttributeError: ''sqlite3.Row'' object has no attribute ''get''','2026-01-27 14:07:42');
INSERT INTO "error_log" VALUES(12,'unhandled_exception','Encountered unknown tag ''endif''. You probably made a nesting mistake. Jinja is expecting this tag, but currently looking for ''endfor''. The innermost block that needs to be closed is ''for''.','http://100.117.106.90:8000/',NULL,'Traceback (most recent call last):
  File "/usr/local/lib/python3.11/site-packages/starlette/middleware/errors.py", line 164, in __call__
    await self.app(scope, receive, _send)
  File "/usr/local/lib/python3.11/site-packages/starlette/middleware/exceptions.py", line 63, in __call__
    await wrap_app_handling_exceptions(self.app, conn)(scope, receive, send)
  ...
  File "/usr/local/lib/python3.11/site-packages/fastapi/routing.py", line 243, in run_endpoint_function
    return await dependant.call(**values)
           ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/app/app/api/routers/ui.py", line 280, in dashboard
    return templates.TemplateResponse(
           ^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/usr/local/lib/python3.11/site-packages/starlette/templating.py", line 209, in TemplateResponse
    template = self.get_template(name)
               ^^^^^^^^^^^^^^^^^^^^^^^
  File "/usr/local/lib/python3.11/site-packages/starlette/templating.py", line 132, in get_template
  ...
  File "/app/app/templates/dashboard.html", line 370, in template
    {% endif %} <!-- End has_any_items -->
    ^^^^^^^^^^^^^^^^^^^^^^^^^
jinja2.exceptions.TemplateSyntaxError: Encountered unknown tag ''endif''. You probably made a nesting mistake. Jinja is expecting this tag, but currently looking for ''endfor''. The innermost block that needs to be closed is ''for''.','2026-01-27 16:06:02');
CREATE TABLE extraction_logs (
    ...
    duration_ms INTEGER,
    created_at TEXT NOT NULL DEFAULT (datetime('now')),
    FOREIGN KEY(tracked_item_id) REFERENCES "tracked_items_old"(id)
);
...
INSERT INTO "extraction_logs" VALUES(110,32,'success','gemini-2.5-flash-lite',56.12,'EUR',NULL,10053,'2026-01-26 23:00:10');
INSERT INTO "extraction_logs" VALUES(111,32,'success','gemini-2.5-flash-lite',56.12,'EUR',NULL,10481,'2026-01-26 23:05:41');
INSERT INTO "extraction_logs" VALUES(112,35,'success','gemini-2.5-flash-lite',41.52,'EUR',NULL,9775,'2026-01-26 23:07:17');
INSERT INTO "extraction_logs" VALUES(113,34,'success','gemini-2.5-flash-lite',13.99,'EUR',NULL,11420,'2026-01-26 23:16:08');
INSERT INTO "extraction_logs" VALUES(114,33,'success','gemini-2.5-flash-lite',9.09,'EUR',NULL,17533,'2026-01-26 23:16:12');
INSERT INTO "extraction_logs" VALUES(115,45,'success','gemini-2.5-flash-lite',0.0,'N/A',NULL,5442,'2026-01-26 23:24:02');
INSERT INTO "extraction_logs" VALUES(116,45,'success','gemini-2.5-flash-lite',0.0,'N/A',NULL,6843,'2026-01-26 23:32:25');
INSERT INTO "extraction_logs" VALUES(117,11,'success','gemini-2.5-flash-lite',15.99,'EUR',NULL,33585,'2026-01-26 23:32:56');
INSERT INTO "extraction_logs" VALUES(118,45,'success','gemini-2.5-flash-lite',0.0,'N/A',NULL,6652,'2026-01-26 23:34:01');
INSERT INTO "extraction_logs" VALUES(119,11,'success','gemini-2.5-flash-lite',15.99,'EUR',NULL,9965,'2026-01-26 23:34:29');
INSERT INTO "extraction_logs" VALUES(120,45,'success','gemini-2.5-flash-lite',0.0,'N/A',NULL,7672,'2026-01-26 23:37:17');
INSERT INTO "extraction_logs" VALUES(121,45,'success','gemini-2.5-flash-lite',0.0,'N/A',NULL,7001,'2026-01-26 23:41:52');
INSERT INTO "extraction_logs" VALUES(122,46,'success','gemini-2.5-flash-lite',0.0,'N/A',NULL,8105,'2026-01-27 13:13:59');
INSERT INTO "extraction_logs" VALUES(123,46,'success','gemini-2.5-flash-lite',69.95,'USD',NULL,8777,'2026-01-27 13:19:33');
INSERT INTO "extraction_logs" VALUES(124,46,'success','gemini-2.5-flash-lite',120.0,'EUR',NULL,8642,'2026-01-27 13:29:35');
INSERT INTO "extraction_logs" VALUES(125,33,'success','gemini-2.5-flash-lite',0.0,'N/A',NULL,11393,'2026-01-27 13:31:29');
INSERT INTO "extraction_logs" VALUES(126,33,'success','gemini-2.5-flash-lite',0.0,'N/A',NULL,10526,'2026-01-27 13:32:12');
INSERT INTO "extraction_logs" VALUES(127,46,'success','gemini-2.5-flash-lite',149.95,'EUR',NULL,12810,'2026-01-27 13:42:57');
INSERT INTO "extraction_logs" VALUES(128,46,'success','gemini-2.5-flash-lite',149.95,'EUR',NULL,73282,'2026-01-27 13:59:45');
INSERT INTO "extraction_logs" VALUES(129,46,'success','gemini-2.5-flash-lite',149.95,'EUR',NULL,9703,'2026-01-27 14:13:10');
INSERT INTO "extraction_logs" VALUES(130,45,'error',NULL,NULL,NULL,'',69476,'2026-01-27 14:14:39');
INSERT INTO "extraction_logs" VALUES(131,33,'success','gemini-2.5-flash-lite',9.09,'EUR',NULL,74115,'2026-01-27 14:16:54');
INSERT INTO "extraction_logs" VALUES(132,47,'success','gemini-2.5-flash-lite',9.5,'EUR',NULL,13243,'2026-01-27 15:38:19');
INSERT INTO "extraction_logs" VALUES(133,48,'success','gemini-2.5-flash-lite',19.99,'EUR',NULL,14488,'2026-01-27 15:50:57');
INSERT INTO "extraction_logs" VALUES(134,11,'success','gemini-2.5-flash-lite',0.0,'N/A',NULL,70829,'2026-01-27 16:44:43');
INSERT INTO "extraction_logs" VALUES(135,32,'success','gemini-2.5-flash-lite',56.12,'EUR',NULL,13956,'2026-01-27 16:45:44');
INSERT INTO "extraction_logs" VALUES(136,11,'success','gemini-2.5-flash-lite',0.0,'N/A',NULL,70970,'2026-01-27 16:47:06');
INSERT INTO "extraction_logs" VALUES(137,11,'success','gemini-2.5-flash-lite',0.0,'N/A',NULL,69958,'2026-01-27 16:49:50');
INSERT INTO "extraction_logs" VALUES(138,34,'success','gemini-2.5-flash-lite',13.99,'EUR',NULL,69428,'2026-01-27 23:01:09');
INSERT INTO "extraction_logs" VALUES(139,11,'success','gemini-2.5-flash-lite',0.0,'N/A',NULL,72636,'2026-01-27 23:45:34');
CREATE TABLE labels (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    name TEXT NOT NULL UNIQUE,
    created_at TEXT NOT NULL DEFAULT (datetime('now'))
...
INSERT INTO "price_history" VALUES(45,'Andrélon Levendige Kleur Kleurverzorgende Shampoo',6.89,'EUR',1.0,'https://www.kruidvat.nl/andrelon-levendige-kleur-kleurverzorgende-shampoo/p/6292452','Kruidvat',NULL,'2026-01-23 23:01:07',1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1);
INSERT INTO "price_history" VALUES(46,'SILK EAU DE TOILETTE N°101 - 100 ML',15.99,'EUR',1.0,'https://www.stradivarius.com/nl/silk-eau-de-toilette-no101--100-ml-l00419056?categoryId=1020208533&colorId=310&style=02&pelement=485588125','STRADIVARIUS',NULL,'2026-01-23 23:01:08',1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1);
INSERT INTO "price_history" VALUES(47,'Oral-B iO Ultimate Clean Opzetborstels',45.99,'EUR',1.0,'https://www.kruidvat.nl/oral-b-io-ultimate-clean-opzetborstels/p/6214290','Kruidvat',NULL,'2026-01-23 23:01:11',1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1);
INSERT INTO "price_history" VALUES(48,'Kruidvat Biologische Psylliumvezels',5.39,'EUR',1.0,'https://www.kruidvat.nl/kruidvat-biologische-psylliumvezels/p/4966221','Kruidvat',NULL,'2026-01-23 23:01:12',1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1);
INSERT INTO "price_history" VALUES(49,'Andrélon Pink Droogshampoo',6.99,'EUR',1.0,'https://www.etos.nl/producten/andrelon-pink-big-volume-droogshampoo-250-ml-120258111.html','Etos',NULL,'2026-01-24 00:51:03',1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1);
INSERT INTO "price_history" VALUES(50,'Whiskas 7+ Kattenbrokken - Kip - Zak 6 x 1.9kg',52.99,'EUR',1.0,'https://www.bol.com/nl/nl/p/whiskas-1-kattenbrokken-kip-zak-6-x-1-9kg/9200000072257568/?cid=1768770255524-1740561506859&bltgh=tvPN9yKWu3yjWl3bpZ1BNw.4_25.28.ProductImage','bol.com',NULL,'2026-01-24 00:55:30',1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1);
INSERT INTO "price_history" VALUES(51,'TORSBODA Integrated dishwasher, IKEA 700, 60 cm',699.0,'EUR',1.0,'https://www.ikea.com/nl/en/p/torsboda-integrated-dishwasher-ikea-700-40548088/','IKEA',NULL,'2026-01-24 00:55:32',1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1);
INSERT INTO "price_history" VALUES(52,'LEGO Botanicals Mini orchidee - 10343',21.99,'EUR',1.0,'https://www.bol.com/nl/nl/p/lego-botanicals-miniorchidee-10343/9300000187249569/?cid=1769042624173-2224743527883&bltgh=dbd70ecd-e5ca-47fa-b254-15f0a7966210.ProductList_Middle.6.ProductTitle','bol.com',NULL,'2026-01-24 00:55:36',1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1);
INSERT INTO "price_history" VALUES(53,'LEGO Icons Bloemen Boeket - Botanical Collection - 10280',46.99,'EUR',1.0,'https://www.bol.com/nl/nl/p/lego-creator-expert-bloemen-boeket-botanical-collection-10280/9300000015132290/?cid=1769042990299-9654515405834&bltgh=4f7e1bb0-52c5-42ce-b6fd-9d52ec9cf68b.ProductList_Middle.12.ProductTitle','bol.com',NULL,'2026-01-24 00:55:43',1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1);
INSERT INTO "price_history" VALUES(54,'ZigBee 3.0 Pro+ Smart LED Controller, 5-in-1, 2.4GHz, WiFi, PWM, LED Controller, 20A Max DC12-24V, Compatible with Alexa, Google Home, Smart Life, Tuya, Smart APP Control for Dimmer, CCT RGBW',29.99,'EUR',1.0,'https://www.amazon.nl/-/en/ZigBee-Controller-DC12-24V-Compatible-Control/dp/B0CXJF6DRM/ref=sr_1_1?crid=CQFNCJCCHHHX&dib=eyJ2IjoiMSJ9.5HMR8hr5boBzpMdf91yhRbDW_bmzSr1uzrlhuXzGs_67jfTFxhDdKihAQXq0_bvvkVZ2BceyDfdsvIdgvlmcyWPOVSI_NByiJOodDN97k-4sFUjn2QYyL0uX0zmZSIGIwpktVHYz8ZGgUH5dookZKpAHH6F8UknMUpu7XW_mrOSuOVHsnEHlYYIhitA_pdx14GW2DiR7vIeCamXhLPk6WV9HbFW7g-OGx4PEFABzdlb3ZMnHGanVaAJ-pfex5iRo27VL7ARoQFMnPkY1BaKJrxC90WZGB6_qB2LDul5zZXg.UzCEKXM89_XpK-aknj4Dnm6de1AkiNUXQGSh6IHbfnE&dib_tag=se&keywords=zigbee+pro%2Bsmart+led+controller+5-in-1+2.4ghz&qid=1769002105&sprefix=zigbee+pro+smart+led+controller+5-in-1+2.4ghz+%2Caps%2C244&sr=8-1','amazon.nl',NULL,'2026-01-24 00:55:51',1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1);
INSERT INTO "price_history" VALUES(55,'LEGO Botanicals Daisies – Artificial Flowers Bouquet with Lavender – Building Kit for Children and Children''s Room Decoration – Gift for Valentine for Girls from 9 Years and Flower Lovers – 11508',11.29,'EUR',1.0,'https://www.amazon.nl/-/en/LEGO-Botanicals-Daisies-Artificial-Decoration/dp/B0FPXDY3X2/?_encoding=UTF8&pd_rd_w=1TaUy&content-id=amzn1.sym.0bd8095e-79f9-45c2-8e70-ee4034022f47:amzn1.symc.752cde0b-d2ce-4cce-9121-769ea438869e&pf_rd_p=0bd8095e-79f9-45c2-8e70-ee4034022f47&pf_rd_r=PA1HNHX1S7PQ1T7VHZPT&pd_rd_wg=6nYVk&pd_rd_r=471d265b-c2e8-49a4-a760-b6fb589b9605&ref_=pd_hp_d_atf_ci_mcx_mr_ca_hp_atf_d','Amazon.nl',NULL,'2026-01-24 00:55:54',1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1);
INSERT INTO "price_history" VALUES(56,'LEGO Botanicals Mini Orchid, Artificial Flowers Set, Plants Building Kit for Adults, Home Accessory and Office Decoration from the Botanical Collection, Gift for Valentine for Woman or Man 10343',21.99,'EUR',1.0,'https://www.amazon.nl/-/en/Botanicals-Artificial-Decoration-Collection-10343/dp/B01N6CJ1QW/ref=sr_1_1?crid=1LUSBYIDN00SB&dib=eyJ2IjoiMSJ9.5ns4G82SO2ZesIiBub3y2ORVCc_CncCqwT-yhmDgHS9Acv3us6w1czBhhnHC05aOLwKgGO04XkVbNzGhyvC5MmaXuE-SHJ8EVNnFNB3bvqdAibabFDl3bEcuiAD13IJ_5Uakk_YIBqWNfTe0Q9LL_3mtQflc1X5iswIrTXY363ARL3o7tKl2Zk7KsM5ydFX9mRiab9gZG0XHyeSpNPEZ8pm1plh5Fy0aH6qxgNh9sZkP89da68HwexCV5QTQuICahCThdXf4eTfeDVNfyBgcW0C45iqGQHhugwY0tsf9c-E.-skxwXVfmUhGSrRXv4Piu_PuQQo-wiSMMaynvHpIdDU&dib_tag=se&keywords=lego+mini+orchidee&qid=1769042886&sprefix=lego+mini+orch%2Caps%2C273&sr=8-1','Amazon.nl',NULL,'2026-01-24 00:55:55',1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1);
INSERT INTO "price_history" VALUES(57,'OLAPLEX BOND MAINTENANCE NO. 7 BONDING OIL',25.08,'EUR',1.0,'https://www.douglas.nl/nl/p/5010033070','DOUGLAS, OLAPLEX',NULL,'2026-01-24 00:55:56',1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1);
INSERT INTO "price_history" VALUES(58,'BTF-LIGHTING FCOB COB RGB CCT Flexible High Density RGB+Warm White+Cool White LED Strip 5M 960LED/M 4800LEDs DC24V 18W/M IP30 Non Waterproof Multicolor for DIY Home Decoration [Energy Class G]',70.99,'EUR',1.0,'https://www.amazon.nl/-/en/BTF-LIGHTING-Flexible-Waterproof-Multicolor-Decoration/dp/B0C3VMV5BP/ref=sr_1_2?crid=4G3PBKIR5ZSJ&dib=eyJ2IjoiMSJ9.40v-SQ54YW-SRJAeIw05m-Hg85YqppMxyUpL1b7Iwsj1H3TtE3Onti_S72Q9luoJ0fNQ4RaiRDbMS28tVM2Kz23BxtxX23SxDRlEa9wK0fARqowRI1lSanbPvHpg2ZsHwx0DFQojXS0BKNRWmkHjk4kCWeCW4mXKwCDPDrAt-KPncb04JogkbA1drNYSYOV4OBL2Z05zTtUOqq-xgF-7LENH50XkBcNq-VYcgbeNWC96ipNmsW0yidnQqCe-mZ5MCTXuPmyTFbdjp-DFNla1_1GS-2tFEf5O4nt9poCYuB8.W9jULAY2bcROfjUbMnwy9YcMvc8Xh9Vtnj_NuAbMHX0&dib_tag=se&keywords=BTF-LIGHTING%2BFCOB%2BRGBCCT%2B(24V%2C%2B960LED%2Fm)&qid=1769001366&sprefix=btf-lighting%2Bfcob%2Brgbcct%2B24v%2B960led%2Fm%2B%2Caps%2C229&sr=8-2&th=1','Amazon.nl',NULL,'2026-01-24 00:55:59',1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1);
INSERT INTO "price_history" VALUES(59,'OLAPLEX No. 7 Bonding Oil, 30 ml',19.99,'EUR',1.0,'https://www.amazon.nl/-/en/OLAPLEX-No-Bonding-Oil-30/dp/B07ZHKTQL3/ref=sr_1_2?crid=3L5IO4YLCLAJR&dib=eyJ2IjoiMSJ9.U5W0cstTUnY_zz16rAT609WmZucTLAPIGGXSsHS-GXHCAWd60gmq-PmhRZLjer1ogPL5shI7rbfbQVO5kv-S7R37xJZlgxfCpmy0vpMg_7R8ZzCls6jtPBgwkQmqiysGBvTT3kgnD8ixykPxL7Ns0hn09t8RwienoAcaPExJAznwMz52pQec11Qylm3UZVSHhMe9me83mWTR-yvFtZa_bX2SEZcnrGGYEzGelnTsyLrimQUbzMWakdiVNLW6Dm1jSb-qpDBW4DrHvfMPei56RxLEWzBQmq1GxQGWBdXDcH0._QYvjFzXyy4C99JAub2Hbf3iKopnl6Oh8PBVCzq5eBQ&dib_tag=se&keywords=olaplex+oil&qid=1769049809&sprefix=olaplex+%2Caps%2C330&sr=8-2','Amazon',NULL,'2026-01-24 00:56:07',1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1);
INSERT INTO "price_history" VALUES(60,'INSTITUTO ESPAÑOL Urea lotion dispenser 950 ml',14.34,'EUR',1.0,'https://www.amazon.nl/-/en/INSTITUTO-ESPA%C3%91OL-Urea-lotion-dispenser/dp/B015OAQEHI/ref=sr_1_5_pp?crid=K6TD4KN9EOUW&dib=eyJ2IjoiMSJ9.uUJ62Jgx_N6vmYW2DlIAlct5mnWPUNZFk2tRYnYI-ZCKb-xpLUN79IqzB3sYcAz9IGgzTc1XfFVDu9F2qfWBW24WVmCpCSEUnHhJ_VFK2MtJmnlkwgA6vXrsDTbVAZI3rIQmsIPeGe74yo7Gady9GSFUWGtgW45fiZVX_NSwiL2IQd_JSN9P0n43JC3UBx027zqHZWAqlTKVoY-SsqmpgM_RVAb-PwYZ4WT_htsqJcl-k04Wy-2XeSaToj8_JrasaKZClyxYhIhxq0nmboEuDcFaxP2LUmLYcLXHYlS8gIM.8fes7PNwp2D3ZxJ1yTg1YfuYlIjY_pybnFERwI3VCGY&dib_tag=se&keywords=instituto+espa%C3%B1ol+urea&qid=1769049762&sprefix=instituto+esp%2Caps%2C821&sr=8-5','Amazon',NULL,'2026-01-24 00:56:17',1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1);
INSERT INTO "price_history" VALUES(61,'INSTITUTO ESPAÑOL Urea 20% restorative cream for rough or dry skin 150 ml',7.48,'EUR',1.0,'https://www.amazon.nl/-/en/INSTITUTO-ESPA%C3%91OL-restorative-cream-rough/dp/B01CS5KK22/ref=sr_1_7?crid=K6TD4KN9EOUW&dib=eyJ2IjoiMSJ9.uUJ62Jgx_N6vmYW2DlIAlct5mnWPUNZFk2tRYnYI-ZCKb-xpLUN79IqzB3sYcAz9IGgzTc1XfFVDu9F2qfWBW24WVmCpCSEUnHhJ_VFK2MtJmnlkwgA6vXrsDTbVAZI3rIQmsIPeGe74yo7Gady9GSFUWGtgW45fiZVX_NSwiL2IQd_JSN9P0n43JC3UBx027zqHZWAqlTKVoY-SsqmpgM_RVAb-PwYZ4WT_htsqJcl-k04Wy-2XeSaToj8_JrasaKZClyxYhIhxq0nmboEuDcFaxP2LUmLYcLXHYlS8gIM.8fes7PNwp2D3ZxJ1yTg1YfuYlIjY_pybnFERwI3VCGY&dib_tag=se&keywords=instituto+espa%C3%B1ol+urea&qid=1769049762&sprefix=instituto+esp%2Caps%2C821&sr=8-7','Amazon',NULL,'2026-01-24 00:56:20',1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1);
INSERT INTO "price_history" VALUES(62,'INSTITUTO ESPAÑOL I.Spanish Urea Gel 1250 ml',10.64,'EUR',1.0,'https://www.amazon.nl/-/en/INSTITUTO-ESPA%C3%91OL-I-Spanish-Urea-1250/dp/B00BN7XF1U/ref=sr_1_6_pp?crid=K6TD4KN9EOUW&dib=eyJ2IjoiMSJ9.uUJ62Jgx_N6vmYW2DlIAlct5mnWPUNZFk2tRYnYI-ZCKb-xpLUN79IqzB3sYcAz9IGgzTc1XfFVDu9F2qfWBW24WVmCpCSEUnHhJ_VFK2MtJmnlkwgA6vXrsDTbVAZI3rIQmsIPeGe74yo7Gady9GSFUWGtgW45fiZVX_NSwiL2IQd_JSN9P0n43JC3UBx027zqHZWAqlTKVoY-SsqmpgM_RVAb-PwYZ4WT_htsqJcl-k04Wy-2XeSaToj8_JrasaKZClyxYhIhxq0nmboEuDcFaxP2LUmLYcLXHYlS8gIM.8fes7PNwp2D3ZxJ1yTg1YfuYlIjY_pybnFERwI3VCGY&dib_tag=se&keywords=instituto+espa%C3%B1ol+urea&qid=1769049762&sprefix=instituto+esp%2Caps%2C821&sr=8-6','Amazon',NULL,'2026-01-24 00:56:21',1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1);
INSERT INTO "price_history" VALUES(63,'Oral-B iO Ultimate Clean Opzetborstels',45.99,'EUR',1.0,'https://www.kruidvat.nl/oral-b-io-ultimate-clean-opzetborstels/p/6214290','Kruidvat.nl',NULL,'2026-01-24 00:56:22',1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1);
INSERT INTO "price_history" VALUES(64,'Kruidvat Biologische Psylliumvezels',5.39,'EUR',1.0,'https://www.kruidvat.nl/kruidvat-biologische-psylliumvezels/p/4966221','Kruidvat',NULL,'2026-01-24 00:56:22',1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1);
INSERT INTO "price_history" VALUES(65,'SILK EAU DE TOILETTE N°101 - 100 ML',15.99,'EUR',1.0,'https://www.stradivarius.com/nl/silk-eau-de-toilette-no101--100-ml-l00419056?categoryId=1020208533&colorId=310&style=02&pelement=485588125','STRADIVARIUS',NULL,'2026-01-24 00:56:23',1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1);
INSERT INTO "price_history" VALUES(66,'Andrélon Levendige Kleur Kleurverzorgende Shampoo',6.89,'EUR',1.0,'https://www.kruidvat.nl/andrelon-levendige-kleur-kleurverzorgende-shampoo/p/6292452','Kruidvat',NULL,'2026-01-24 00:56:23',1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1);
INSERT INTO "price_history" VALUES(67,'Kruidvat Biologische Psylliumvezels',5.39,'EUR',1.0,'https://www.kruidvat.nl/kruidvat-biologische-psylliumvezels/p/4966221','Kruidvat',NULL,'2026-01-24 05:21:36',1,'Gratis verzending badge is present. Action badge indicates ''Kruidvat maaltijdverrijkers''.',NULL,0.0,'second_half_price','2e HALVE PRIJS',NULL,NULL,NULL,1);
INSERT INTO "price_history" VALUES(68,'André Rellon Levendige Kleur Kleurverzorgende Shampoo',6.89,'EUR',1.0,'https://www.kruidvat.nl/andrelon-levendige-kleur-kleurverzorgende-shampoo/p/6292452','Kruidvat',NULL,'2026-01-24 05:46:17',1,NULL,NULL,0.0,'multibuy','3 voor 11.00',NULL,NULL,NULL,1);
INSERT INTO "price_history" VALUES(69,'Andrélon Pin Droogshampoo',6.99,'EUR',1.0,'https://www.etos.nl/producten/andrelon-pink-big-volume-droogshampoo-250-ml-120258111.html','Etos',NULL,'2026-01-24 05:47:00',1,NULL,NULL,0.0,'bogo','1+1 gratis',NULL,NULL,NULL,1);
INSERT INTO "price_history" VALUES(70,'Oral-B iO Ultimate Clean Opzetborstels',45.99,'EUR',1.0,'https://www.kruidvat.nl/oral-b-io-ultimate-clean-opzetborstels/p/6214290','Kruidvat',NULL,'2026-01-24 05:47:27',1,NULL,NULL,114.99,'none','Voor 45.99',NULL,NULL,NULL,1);
INSERT INTO "price_history" VALUES(71,'Oral-B iO Ultimate Clean Opzetborstels',45.99,'EUR',1.0,'https://www.kruidvat.nl/oral-b-io-ultimate-clean-opzetborstels/p/6214290','Kruidvat Online - Verkocht en verstuurd door Kruidvat','single_product','2026-01-24 06:35:43',1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1);
INSERT INTO "price_history" VALUES(72,'N/A',0.0,'N/A',1.0,'https://www.ah.nl/producten/product/wi411496/andre%CC%81lon-pink-big-volume-droogshampoo','N/A',NULL,'2026-01-24 06:36:16',0,'The provided image is completely blank and does not contain any product information.',NULL,NULL,'none','N/A',NULL,NULL,NULL,1);
...
For clarity, given the options, and considering that the product listing is on Kruidvat''s website, Kruidvat is the store. The',NULL,'2026-01-24 23:15:33',1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1);
...
Note: The actual product is sold by Kaviarvoorjehaar.nl, not directly by Kruidvat.nl. The URL for the seller is displayed as Kaviarvoorjehaar.nl and is listed as ''Verkocht en verstuurd door''. However, the main website displayed is Kruidvat.nl, hence listing both as store_name. We are listing Kaviarvoorjehaar.nl as the seller and Kruidvat.nl as the platform where it is being sold from. The page also mentions ''Verkocht en verstuurd door Kaviarvoorjehaar.nl'', implying a third-party seller on Kruidvat.nl marketplace. Since the prompt requests for the store name, and Kruidvat is the main brand shown on the page, it is being included. If only the direct seller was to be considered, it would be Kaviarvoorjehaar.nl. The context of the prompt implies a direct retail purchase, and in this case, Kruidvat.nl is the platform presented to the user. Therefore, it is reasonable to list Kruidvat.nl as the store name, and Kaviarvoorjehaar.nl as the seller.  The prompt does not have a separate field for ''seller''.  Therefore, to provide the most context, both are included in the store_name field with a note.  However, if only one should be chosen, then Kaviarvoorjehaar.nl would be the correct choice for the direct seller.  Given the prompt asks for ''store/retailer name'', and Kruidvat.nl is the retailer platform, it should be listed first. For clarity, we are listing both to avoid ambiguity. If only one should be chosen, Kaviarvoorjehaar.nl is the seller. The product is available online, indicated by ''Online op voorraad.'' and the ''Voeg toe'' button, despite no explicit stock information like ''In stock''. The price is displayed as a discounted price with a yellow tag and',NULL,'2026-01-24 23:15:56',1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1);
INSERT INTO "price_history" VALUES(82,'Olaplex No.7 Bonding Oil',29.5,'EUR',1.0,'https://www.etos.nl/producten/olaplex-no.-7-bond-oil-30-ml%C2%A0-120799558.html','Etos',NULL,'2026-01-24 23:20:57',1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1);
INSERT INTO "price_history" VALUES(83,'ZigBee 3.0 Pro+ Smart LED Controller, 5-in-1, 2.4GHz, WiFi, PWM, LED Controller, 20A Max DC12-24V, Compatible with Alexa, Google Home, Smart Life, Tuya, Smart APP Control for Dimmer, CCT RGBW',29.99,'EUR',1.0,'https://www.amazon.nl/-/en/ZigBee-Controller-DC12-24V-Compatible-Control/dp/B0CXJF6DRM/ref=sr_1_1?crid=3KJFSUOFW9KK&dib=eyJ2IjoiMSJ9.7Az3zpxSW3xYEMYzQmVlCUgJDtuPAMTVhy4aovkVQzC7jfTFxhDdKihAQXq0_bvvuWvbGWsmJpZ1BOAwd5wP8AhOWOyZ0pJdrCqTf4C4t5a6eQuEC62gGOt1V0vaRms3HBtu6Hp0YbgiIPaEVG3GW1zdNta20SEGxfZempAfYeEHIeoxX2I6ecea2OE3ZB0F_mpElLk7WVN95YsK9j7S78taU73Ao0rgLqk4M945MtCatpIL0UJZKCniTngmDKYwNunZKYHWFdAG8CDIu78xk_X5r1BzTanTKN9rhH2KNX8.pJHofQ12tn8kgRAF7YSHkHJ1iX7HibYhsc-lpX3zIvU&dib_tag=se&keywords=ZigBee+3.0+Pro%2B+Smart+LED+Controller&qid=1769353809&sprefix=zigbee+3.0+pro+smart+led+controller%2Caps%2C243&sr=8-1','amazon.nl (Tanshop is the seller, not the store name for this context.) (The Toys Store is for play fun, irrelevant to product.)',NULL,'2026-01-25 15:11:38',1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1);
INSERT INTO "price_history" VALUES(84,'Whiskas 7+ Kattenbrokken - Kip - Zak 6 x 1.9kg',52.99,'EUR',1.0,'https://www.bol.com/nl/nl/p/whiskas-1-kattenbrokken-kip-zak-6-x-1-9kg/9200000072257568/?cid=1768770255524-1740561506859&bltgh=tvPN9yKWu3yjWl3bpZ1BNw.4_25.28.ProductImage','bol.com',NULL,'2026-01-25 15:13:30',1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1);
INSERT INTO "price_history" VALUES(85,'ACIDIC BONDING CONCENTRATE conditioner',50.0,'EUR',1.0,'https://www.amazon.nl/-/en/916-89702-ACIDIC-BONDING-CONCENTRATE-conditioner/dp/B0C31QQYVL/ref=sr_1_15?crid=2G2LWT0HV2IEY&dib=eyJ2IjoiMSJ9.ZqzK-u2o4rC2tz2rBeC3zJFBnapphKtmXIg7fK7U0axvLAS1bFzwnFd7ittp-oMVznEl4bEJIYqDXOBuhUEbIG0rhc60RbvDWli7ek7FYHvK94VxsfF4AAEqOfoKJ9hbnI1DwNDBSsB7y5E5EvhG9gy_T9trKW4pM--xBxBu8opPW7t4EMPB-tu2MKv4O30-ElLLATCHdqeaGeqI5QrNWwV-o8pMhGH-nHaQr3NiiVTIbZ-Wgk1FCu8e4SALD2J8uz_hDA9M2jT4o86tQhtY-a-7Q6kUeUt4WBdZvGeA3Ks.AJGKCFhfsQpvfc78_ZVkOlJcrngMD7xQeupbs-_WCM8&dib_tag=se&keywords=Redken+Acidic+Bonding+Concentrate+conditioner&qid=1769354336&sprefix=redken+acidic+bonding+concentrate+conditione%2Caps%2C247&sr=8-15','Amazon.nl (Redken Store is mentioned, but Amazon is the retailer of the page itself.)',NULL,'2026-01-25 15:26:06',1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1);
INSERT INTO "price_history" VALUES(86,'CeraVe Schuimende Reiniger Navulling 473 ml',16.65,'EUR',1.0,'https://www.etos.nl/producten/cerave-schuimende-reinigingsgel-navulling-473-ml-120850931.html','Etos',NULL,'2026-01-25 17:18:30',1,'Online bijna uitverkocht. Voor 22:00 uur besteld, morgen in huis. Beperkt beschikbaar in winkels.',NULL,0.0,'none','Nóg meer voordeel met Mijn Etos',0.0,0.0,NULL,1);
INSERT INTO "price_history" VALUES(87,'L''Oréal Paris Elvive Bond Repair Rescue Pre-Shampoo',13.99,'EUR',1.0,'https://www.kruidvat.nl/loreal-paris-elvive-bond-repair-rescue-pre-shampoo/p/5786583','Kruidvat',NULL,'2026-01-25 17:19:01',1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1);
INSERT INTO "price_history" VALUES(88,'CeraVe Schuimende reiniger',28.95,'EUR',1.0,'https://www.etos.nl/producten/cerave-schuimende-reinigingsgel-976-ml-120599556.html','Etos',NULL,'2026-01-25 17:44:19',1,'Online op voorraad',NULL,0.0,'none','Gratis bezorging vanaf €35',NULL,NULL,NULL,1);
INSERT INTO "price_history" VALUES(89,'L''Oréal Paris Elvive Bond Repair Pre-shampoo',12.99,'EUR',1.0,'https://www.etos.nl/producten/loreal-paris-elvive-bond-repair-pre-shampoo-200-ml-120662519.html','Etos.nl (inferred from logo and URL structure if available, but not explicitly in the image elements that were provided to analyze on its own.)',NULL,'2026-01-25 17:45:34',1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1);
INSERT INTO "price_history" VALUES(90,'LEGO Botanicals madeliefjes 11508',49.99,'EUR',1.0,'https://www.intertoys.nl/lego-botanicals-madeliefjes-11508','Intertoys',NULL,'2026-01-25 17:57:55',1,'50 minuten korting!',NULL,0.0,'percentage_off','Op dit moment 50 minuten korting!',0.0,0.0,NULL,1);
INSERT INTO "price_history" VALUES(91,'BOND MAINTENANCE NO. 7 BONDING OIL',25.08,'EUR',1.0,'https://www.douglas.nl/nl/p/5010033070','DOUGLAS COLLECTION OLAPLEX HOME & LIFESTYLE ACTIES OUTLET VIDEO''S SKINCARE DEALS KLAN HEALTHY LIVING MAKE-UP PARFUM MERKEN NIEUW & TRENDING GEZICHT LICHAAM HAAR GEZONDHEID HOME & LIFESTYLE DOUGLAS COLLECTION ACTIES OUTLET VIDEO''S SKINCARE DEALS KLAN ACTIES OUTLET VIDEO''S SKINCARE DEALS KLAN BEAUTY CARD STORES GIFT CARD KLANTENSERVICE OLAPLEX HAAROLIE BOND MAINTENANCE NO. 7 BONDING OIL 30 ml Adviesprijs* € 29,50 € 25,08 Dit is 14% lager dan de adviesprijs BESTE PRIJS DÖUGUS PRIJSTIP Online: Op voorraad Gratis verzending Nu besteld, di, 27.01.2026 in huis. Info *De adviesprijs is de prijs die een fabrikant of leverancier aanraadt voor een artikel VOEG TOE AAN WINKELMANDJE Click & Collect Bekijk de voorraad in je favoriete store HIGHLIGHTS - Geeft glans, soepelheid en heldere kleuren - Temt pluisig en weerbarstig haar - UV- en hittebescherming tot 232 °C - Styling en bescherming in één Vrij Van Parabenen Sulfmaat Vrij Veganistisch PH-Niveau Neutraal OLAPLEX BOND MAINTENANCE NO. 7 BONDING OIL HAAROLIE 30 ml Adviesprijs* € 29,50 € 25,08 Dit is 14% lager dan de adviesprijs BESTE PRIJS DÖUGUS PRIJSTIP Online: Op voorraad Gratis verzending Nu besteld, di, 27.01.2026 in huis. Info *De adviesprijs is de prijs die een fabrikant of leverancier aanraadt voor een artikel VOEG TOE AAN WINKELMANDJE Click & Collect Bekijk de voorraad in je favoriete store HIGHLIGHTS - Geeft glans, soepelheid en heldere kleuren - Temt pluisig en weerbarstig haar - UV- en hittebescherming tot 232 °C - Styling en bescherming in één Vrij Van Parabenen Sulfmaat Vrij Veganistisch PH-Niveau Neutraal',NULL,'2026-01-25 23:00:30',1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1);
INSERT INTO "price_history" VALUES(92,'Cerave Moisturizing Cleansing Foam 1l',23.16,'EUR',1.0,'https://www.amazon.nl/-/en/Cerave-Moisturizing-Cleansing-Foam-1l/dp/B07HF991NV/ref=sr_1_1?crid=27345PXLH8UFV&dib=eyJ2IjoiMSJ9.25cFludDdSedIn9rU8Kttm2NGT1hEv-WfRrRxylpBOxfH3kXlEoAKwg-JFmT4L6IqRVRfUxanEY1uL_9__4lnM9sK_xcMlhaj1Go_9lx5W9p84t3bQ318x5ehGwvZh7qNqyJxwmKU4kZXZKSFZDGEma3PRlsaRC1IbIGgdcbUwdtG333gAMPTt5woXkK9pQI1AUWthldiXGxKj6xIHPAQRSoncVkw6Ew1l2ZF2diPtQLiufAFF809KkIh1iAz1tYajd4V3Y9to86d1lvGGy9rMo9Wmtv9wCrsNCws-zCqCc.rKXuS6CYv0o8ZdlePhzWgE6M8VTismUwWDTcQDEFWgo&dib_tag=se&keywords=CeraVe%2BFoaming%2BCleansing%2BGel&qid=1769360669&sprefix=cerave%2Bfoaming%2Bcleansing%2Bgel%2Caps%2C318&sr=8-1&th=1','Amazon.nl (implied from URL and cookie banner mentions of Amazon services/stores/on Fire TV and Amazon.nl header, however not explicitly stated as the retailer for THIS product necessarily, but the platform.) If you mean the brand name, that is Cerave. Since ''store_name'' is typically the retailer/platform, I''m going with Amazon.nl context.) NOTE: The screenshot is from Amazon.nl, which functions as the retailer/platform. Therefore, Amazon.nl is the most appropriate value for ''store_name''. Explicitly stating this to avoid confusion with the Brand name ''Cerave''. The brand name ''Cerave'' is provided separately below, if needed, but it is not the ''store_name''. Actual retailer name is derived from the URL and context of the website, as the platform where the product is sold. Thus, ''Amazon.nl'' is the most accurate representation of the store/retailer, as it is the marketplace hosting the product listing. The provided crops do not contain any explicit mention of the retailer''s name other than ''Amazon.nl'' in the header, which is the platform, and thus serves as the store_name in this context. This is standard practice for e-commerce platforms where multiple sellers may list their products. Therefore, ''Amazon.nl'' is the correct store name. The context of the question specifies to extract store/retailer name ''if visible''. The URL and header clearly indicate Amazon.nl is the platform, which is the retailer in this context. Thus, ''Amazon.nl'' is extracted. Also, The value ''Amazon.nl'' is derived from the website''s header, which is the platform where the product is listed. Therefore, it functions as the retailer in this scenario. Thus, ''Amazon.nl'' is the most accurate value for ''store_name''. It is not explicitly stated as the seller, but the platform name which is common practice. Based on the provided screenshot and context, ''Amazon.nl'' represents the store/retailer where the product is being sold. This is evident from the URL and the website''s header. Therefore, ''Amazon.nl'' is the correct value for ''store_name''. The screenshot clearly displays ''Amazon.nl'' in the header, indicating the platform and thus the retailer for this transaction. Therefore, the store_name is ''Amazon.nl''. The website''s header shows',NULL,'2026-01-25 23:00:38',1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1);
INSERT INTO "price_history" VALUES(93,'SILK EAU DE TOILETTE N°101 - 100 ML',15.99,'EUR',1.0,'https://www.stradivarius.com/nl/silk-eau-de-toilette-no101--100-ml-l00419056?categoryId=1020208533&colorId=310&style=02&pelement=485588125','STRADIVARIUS',NULL,'2026-01-25 23:00:38',1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1);
INSERT INTO "price_history" VALUES(94,'Redken Acidic Bonding Concentrate conditioner',56.12,'EUR',1.0,'https://www.amazon.nl/-/en/916-89702-ACIDIC-BONDING-CONCENTRATE-conditioner/dp/B0C31QQYVL/ref=sr_1_15?crid=2G2LWT0HV2IEY&dib=eyJ2IjoiMSJ9.ZqzK-u2o4rC2tz2rBeC3zJFBnapphKtmXIg7fK7U0axvLAS1bFzwnFd7ittp-oMVznEl4bEJIYqDXOBuhUEbIG0rhc60RbvDWli7ek7FYHvK94VxsfF4AAEqOfoKJ9hbnI1DwNDBSsB7y5E5EvhG9gy_T9trKW4pM--xBxBu8opPW7t4EMPB-tu2MKv4O30-ElLLATCHdqeaGeqI5QrNWwV-o8pMhGH-nHaQr3NiiVTIbZ-Wgk1FCu8e4SALD2J8uz_hDA9M2jT4o86tQhtY-a-7Q6kUeUt4WBdZvGeA3Ks.AJGKCFhfsQpvfc78_ZVkOlJcrngMD7xQeupbs-_WCM8&dib_tag=se&keywords=Redken+Acidic+Bonding+Concentrate+conditioner&qid=1769354336&sprefix=redken+acidic+bonding+concentrate+conditione%2Caps%2C247&sr=8-15','Amazon',NULL,'2026-01-26 23:00:10',1,'The price displayed is €56.12 for 100 ml. The total volume is 1000 ml.',NULL,0.0,'none','none',NULL,NULL,'["1000 ml"]',1);
INSERT INTO "price_history" VALUES(95,'ACIDIC BONDING CONCENTRATE conditioner',56.12,'EUR',1.0,'https://www.amazon.nl/-/en/916-89702-ACIDIC-BONDING-CONCENTRATE-conditioner/dp/B0C31QQYVL/ref=sr_1_15?crid=2G2LWT0HV2IEY&dib=eyJ2IjoiMSJ9.ZqzK-u2o4rC2tz2rBeC3zJFBnapphKtmXIg7fK7U0axvLAS1bFzwnFd7ittp-oMVznEl4bEJIYqDXOBuhUEbIG0rhc60RbvDWli7ek7FYHvK94VxsfF4AAEqOfoKJ9hbnI1DwNDBSsB7y5E5EvhG9gy_T9trKW4pM--xBxBu8opPW7t4EMPB-tu2MKv4O30-ElLLATCHdqeaGeqI5QrNWwV-o8pMhGH-nHaQr3NiiVTIbZ-Wgk1FCu8e4SALD2J8uz_hDA9M2jT4o86tQhtY-a-7Q6kUeUt4WBdZvGeA3Ks.AJGKCFhfsQpvfc78_ZVkOlJcrngMD7xQeupbs-_WCM8&dib_tag=se&keywords=Redken+Acidic+Bonding+Concentrate+conditioner&qid=1769354336&sprefix=redken+acidic+bonding+concentrate+conditione%2Caps%2C247&sr=8-15','Amazon.nl',NULL,'2026-01-26 23:05:41',1,'The product size is 1000 ml which is equivalent to 1.0 L.',NULL,0.0,'none','none',NULL,NULL,NULL,1);
INSERT INTO "price_history" VALUES(96,'REDKEN, Acidic Bonding Concentrate Shampoo,1 L (1er Pack),No',41.52,'EUR',1.0,'https://www.amazon.nl/-/en/REDKEN-Acidic-Bonding-Concentrate-Shampoo/dp/B093QNKSYR/ref=pd_bxgy_d_sccl_1/260-1856934-5132330?pd_rd_w=5uDZy&content-id=amzn1.sym.f55d1bfa-6e70-4525-8a1e-d27f38476426&pf_rd_p=f55d1bfa-6e70-4525-8a1e-d27f38476426&pf_rd_r=JCXHMAPQWYV6JP5TJZSB&pd_rd_wg=hEwbq&pd_rd_r=46f5e312-c293-4f76-a698-d15ab20bd67b&pd_rd_i=B093QNKSYR&psc=1','Amazon',NULL,'2026-01-26 23:07:17',1,'The size of the product is 1 L.',NULL,0.0,'none','none',NULL,NULL,NULL,1);
INSERT INTO "price_history" VALUES(97,'L''Oréal Paris Elvive Bond Repair Rescue Pre-Shampoo',13.99,'EUR',1.0,'https://www.kruidvat.nl/loreal-paris-elvive-bond-repair-rescue-pre-shampoo/p/5786583','Kruidvat',NULL,'2026-01-26 23:16:08',1,NULL,NULL,0.0,'bogo','1+1 gratis',NULL,NULL,NULL,1);
INSERT INTO "price_history" VALUES(98,'Elvive Bond Repair Pre-shampoo 12%',9.09,'EUR',1.0,'https://www.etos.nl/producten/loreal-paris-elvive-bond-repair-pre-shampoo-200-ml-120662519.html','Etos',NULL,'2026-01-26 23:16:12',1,NULL,NULL,12.99,'percentage_off','30% korting',30.0,NULL,NULL,1);
INSERT INTO "price_history" VALUES(99,'N/A',0.0,'N/A',1.0,'https://www.levi.com/NL/nl_NL/kleding/dames/jeans/xl-lightweight-overall/p/001V00000','N/A',NULL,'2026-01-26 23:24:02',0,'Access Denied. You don''t have permission to access the URL.',NULL,0.0,'none',NULL,0.0,0.0,NULL,1);
INSERT INTO "price_history" VALUES(100,'Levis Overall',0.0,'N/A',1.0,'https://www.levi.com/NL/nl_NL/kleding/dames/jeans/xl-lightweight-overall/p/001V00000','Levi''s',NULL,'2026-01-26 23:32:25',0,'Access denied. Cannot retrieve product information.',NULL,0.0,'none',NULL,0.0,0.0,NULL,1);
INSERT INTO "price_history" VALUES(101,'SILK EAU DE TOILETTE N°101 - 100 ML',15.99,'EUR',1.0,'https://www.stradivarius.com/nl/silk-eau-de-toilette-no101--100-ml-l00419056?categoryId=1020208533&colorId=310&style=02&pelement=485588125','STRADIVARIUS
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																Kostenloser Versand für diese Bestellung, um Ihren Warenkorb zu vervollständigen!',NULL,'2026-01-26 23:32:56',1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1);
INSERT INTO "price_history" VALUES(102,'Levis Overall',0.0,'N/A',1.0,'https://www.levi.com/NL/nl_NL/kleding/dames/jeans/xl-lightweight-overall/p/001V00000','Levi''s',NULL,'2026-01-26 23:34:01',0,'Access Denied. You don''t have permission to access "http://www.levi.com/NL/nl_NL/kleding/dames/jeans/xl-lightweight-overall/p/001V00000" on this server.',NULL,0.0,'none','none',NULL,NULL,NULL,1);
INSERT INTO "price_history" VALUES(103,'SILK EAU DE TOILETTE N°101 - 100 ML',15.99,'EUR',1.0,'https://www.stradivarius.com/nl/silk-eau-de-toilette-no101--100-ml-l00419056?categoryId=1020208533&colorId=310&style=02&pelement=485588125','STRADIVARIUS',NULL,'2026-01-26 23:34:29',1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1);
INSERT INTO "price_history" VALUES(104,'Levis Overall',0.0,'N/A',1.0,'https://www.levi.com/NL/nl_NL/kleding/dames/jeans/xl-lightweight-overall/p/001V00000','Levi''s',NULL,'2026-01-26 23:37:17',0,'Access Denied. You don''t have permission to access "http://www.levi.com/NL/nl_NL/kleding/dames/jeans/xl-lightweight-overall/p/001V00000" on this server.',NULL,0.0,'none',NULL,0.0,0.0,NULL,1);
INSERT INTO "price_history" VALUES(105,'Levis Overall',0.0,'N/A',1.0,'https://www.levi.com/NL/nl_NL/kleding/dames/jeans/xl-lightweight-overall/p/001V00000','Levi''s',NULL,'2026-01-26 23:41:52',0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1);
INSERT INTO "price_history" VALUES(106,'Levis Overall',0.0,'N/A',1.0,'https://www.zalando.nl/levis-overall-tuinbroek-invested-indigo-le221t02g-k12.html',NULL,NULL,'2026-01-27 13:13:59',0,'The provided image is blank and does not contain any product information. Therefore, I cannot extract the requested details.',NULL,0.0,'none','none',NULL,NULL,NULL,1);
INSERT INTO "price_history" VALUES(107,'Levi''s® Ribcage Straight Ankle Jeans',69.95,'USD',1.0,'https://www.zalando.nl/levis-overall-tuinbroek-invested-indigo-le221t02g-k12.html','Levi''s®',NULL,'2026-01-27 13:19:33',0,NULL,NULL,98.0,'none',NULL,NULL,NULL,NULL,1);
INSERT INTO "price_history" VALUES(108,'Levi''s Vintage Clothing 1950s
Shortalls',120.0,'EUR',1.0,'https://www.zalando.nl/levis-overall-tuinbroek-invested-indigo-le221t02g-k12.html',NULL,NULL,'2026-01-27 13:29:35',0,'Size M is not available.',NULL,0.0,'none',NULL,NULL,NULL,NULL,1);
INSERT INTO "price_history" VALUES(109,'Elvive Bond Repair Pre-shampoo',0.0,'N/A',1.0,'https://www.etos.nl/producten/loreal-paris-elvive-bond-repair-pre-shampoo-200-ml-120662519.html','Etos',NULL,'2026-01-27 13:31:29',0,'The consent modal is blocking the product details. Cannot confirm availability or exact price for 200.0 ml size.',NULL,0.0,'none','N/A',0.0,0.0,NULL,1);
INSERT INTO "price_history" VALUES(110,'Elvive Bond Repair Pre-shampoo 12%',0.0,'N/A',1.0,'https://www.etos.nl/producten/loreal-paris-elvive-bond-repair-pre-shampoo-200-ml-120662519.html','Etos',NULL,'2026-01-27 13:32:12',0,'A privacy modal is blocking the view of the page, therefore price and availability information cannot be reliably extracted. The target product name has been extracted. The product is listed as available on the page, but no price information could be extracted.',NULL,0.0,'none','null',0.0,0.0,NULL,1);
INSERT INTO "price_history" VALUES(111,'Levi''s® XL OVERALL - Denim tuinbroek - invested indigo',149.95,'EUR',1.0,'https://www.zalando.nl/levis-overall-tuinbroek-invested-indigo-le221t02g-k12.html',NULL,NULL,'2026-01-27 13:42:57',0,'The target size ''M'' is not selectable or available. No discount information is visible for this item.',NULL,NULL,'none','inclusief btw',NULL,NULL,NULL,1);
INSERT INTO "price_history" VALUES(112,'Levi''s® XL Overall - Denim overall - invested indigo',149.95,'EUR',1.0,'https://www.zalando.nl/levis-overall-tuinbroek-invested-indigo-le221t02g-k12.html','Zalando',NULL,'2026-01-27 13:59:45',0,NULL,NULL,0.0,'none',NULL,NULL,NULL,NULL,1);
INSERT INTO "price_history" VALUES(113,'Levis
                        
                        XL OVERALL - Denim invested indigo',149.95,'EUR',1.0,'https://www.zalando.nl/levis-overall-tuinbroek-invested-indigo-le221t02g-k12.html','Zalando',NULL,'2026-01-27 14:13:10',1,'The price is not confirmed for size M, as the size selection is not interactive and size M is not explicitly selected.',NULL,0.0,'none',NULL,NULL,NULL,NULL,1);
INSERT INTO "price_history" VALUES(114,'L''Oréal Paris Elvive Bond Repair Pre-shampoo',9.09,'EUR',1.0,'https://www.etos.nl/producten/loreal-paris-elvive-bond-repair-pre-shampoo-200-ml-120662519.html','Etos',NULL,'2026-01-27 14:16:54',1,'The price shown is for 200ml, which is the target size.',NULL,12.99,'percentage_off','30% korting',30.0,NULL,NULL,1);
INSERT INTO "price_history" VALUES(115,'Schulke Octenisan Antimicrobial Wash Lotion 500ML',9.5,'EUR',1.0,'https://www.amazon.nl/-/en/gp/product/B0036IKUTE/ref=ox_sc_act_title_3?smid=AW7QLILMW1NRG&psc=1','Amazon',NULL,'2026-01-27 15:38:19',1,NULL,NULL,21.63,'percentage_off','-56%',56.0,NULL,NULL,1);
INSERT INTO "price_history" VALUES(116,'Olaplex No. 4C Bond Maintenance Purifying Shampoo',19.99,'EUR',1.0,'https://www.amazon.nl/-/en/gp/product/B0B4SP2CK4/ref=ox_sc_act_title_5?smid=A17D2BRD4YMT0X&psc=1','Amazon.nl',NULL,'2026-01-27 15:50:57',1,'The price is based on the 250ml size. The original price (RRP) was €29.50.',NULL,29.5,'percentage_off','-32%',32.0,NULL,NULL,1);
INSERT INTO "price_history" VALUES(117,'Stradivarius 101 Silk Eau de Parfum',0.0,'N/A',1.0,'https://www.stradivarius.com/nl/silk-eau-de-toilette-no101--100-ml-l00419056?categoryId=1020208533&colorId=310&style=02&pelement=485588125','Stradivarius',NULL,'2026-01-27 16:44:43',0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1);
INSERT INTO "price_history" VALUES(118,'Redken Acidic Bonding Concentrate conditioner',56.12,'EUR',1.0,'https://www.amazon.nl/-/en/916-89702-ACIDIC-BONDING-CONCENTRATE-conditioner/dp/B0C31QQYVL/ref=sr_1_15?crid=2G2LWT0HV2IEY&dib=eyJ2IjoiMSJ9.ZqzK-u2o4rC2tz2rBeC3zJFBnapphKtmXIg7fK7U0axvLAS1bFzwnFd7ittp-oMVznEl4bEJIYqDXOBuhUEbIG0rhc60RbvDWli7ek7FYHvK94VxsfF4AAEqOfoKJ9hbnI1DwNDBSsB7y5E5EvhG9gy_T9trKW4pM--xBxBu8opPW7t4EMPB-tu2MKv4O30-ElLLATCHdqeaGeqI5QrNWwV-o8pMhGH-nHaQr3NiiVTIbZ-Wgk1FCu8e4SALD2J8uz_hDA9M2jT4o86tQhtY-a-7Q6kUeUt4WBdZvGeA3Ks.AJGKCFhfsQpvfc78_ZVkOlJcrngMD7xQeupbs-_WCM8&dib_tag=se&keywords=Redken+Acidic+Bonding+Concentrate+conditioner&qid=1769354336&sprefix=redken+acidic+bonding+concentrate+conditione%2Caps%2C247&sr=8-15','Amazon.nl',NULL,'2026-01-27 16:45:44',1,NULL,NULL,0.0,'none',NULL,NULL,NULL,NULL,1);
INSERT INTO "price_history" VALUES(119,'Stradivarius 101 Silk Eau de Parfum',0.0,'N/A',1.0,'https://www.stradivarius.com/nl/silk-eau-de-toilette-no101--100-ml-l00419056?categoryId=1020208533&colorId=310&style=02&pelement=485588125','STRADIVARIUS',NULL,'2026-01-27 16:47:06',0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1);
INSERT INTO "price_history" VALUES(120,'SILK EAU DE TOILETTE N°101 - 100 ML',0.0,'N/A',1.0,'https://www.stradivarius.com/nl/silk-eau-de-toilette-no101--100-ml-l00419056?categoryId=1020208533&colorId=310&style=02&pelement=485588125','Stradivarius',NULL,'2026-01-27 16:49:50',0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1);
INSERT INTO "price_history" VALUES(121,'L''Oréal Paris Elvive Bond Repair Rescue Pre-Shampoo',13.99,'EUR',1.0,'https://www.kruidvat.nl/loreal-paris-elvive-bond-repair-rescue-pre-shampoo/p/5786583','Kruidvat',NULL,'2026-01-27 23:01:09',1,NULL,NULL,0.0,'bogo','1+1 gratis',NULL,NULL,'["200ml"]',1);
INSERT INTO "price_history" VALUES(122,'Stradivarius 101',0.0,'N/A',1.0,'https://www.stradivarius.com/nl/silk-eau-de-toilette-no101--100-ml-l00419056?categoryId=1020208533&colorId=310&style=02&pelement=485588125','Stradivarius',NULL,'2026-01-27 23:45:34',0,'No price information available on the visible part of the page.',NULL,0.0,'none','none',NULL,NULL,NULL,1);
CREATE TABLE products (
    ...
    created_at TEXT NOT NULL DEFAULT (datetime('now'))
, planned_date TEXT);
INSERT INTO "products" VALUES(2,'LED Strip','Lighting','recurring',65.0,NULL,'2026-01-21 13:17:17','2026-W09');
INSERT INTO "products" VALUES(3,'Power Supply Light Strip','Electronics','recurring',13.0,NULL,'2026-01-21 13:23:10','2026-W09');
INSERT INTO "products" VALUES(4,'ZigBee 3.0 Pro+ Smart LED Controller','Smart home devices','recurring',25.0,'unit','2026-01-21 13:29:58','2026-W09');
INSERT INTO "products" VALUES(5,'Whiskas 7+ Kattenbrokken','Pet food','recurring',51.0,'pack','2026-01-21 13:32:13',NULL);
INSERT INTO "products" VALUES(10,'Stradivarius 101','Personal care','recurring',100.0,'l','2026-01-22 02:52:34','2026-W08');
INSERT INTO "products" VALUES(11,'Olaplex No. 7 Bonding Oil','Hair Care','recurring',666.33,'L','2026-01-22 03:26:55',NULL);
INSERT INTO "products" VALUES(18,'Psyllium Husk','Health foods','recurring',20.0,'kg','2026-01-23 22:50:36',NULL);
INSERT INTO "products" VALUES(19,'Redken ABC Conditioner','Hair Care','recurring',50.0,'L','2026-01-25 15:24:58','2026-W07');
INSERT INTO "products" VALUES(20,'Elvive Bond Repair Pre-shampoo 12%','Hair Care','recurring',46.0,'L','2026-01-25 15:31:31','2026-W05');
INSERT INTO "products" VALUES(21,'Redken ABC Shampoo','Hair Care','recurring',40.0,'L','2026-01-25 15:42:03','2026-W07');
INSERT INTO "products" VALUES(29,'CeraVe Moisturizing Cleansing Foam','Skincare','recurring',25.0,'L','2026-01-25 17:05:59',NULL);
INSERT INTO "products" VALUES(30,'Lego Botanicals Bouquet with Tulips','Home decor','recurring',35.0,'unit','2026-01-25 17:23:21',NULL);
INSERT INTO "products" VALUES(31,'Lego Botanicals Daisies','Home decor','recurring',11.0,'unit','2026-01-25 17:55:33','2026-W11');
INSERT INTO "products" VALUES(33,'Levis Overall','Clothing','recurring',75.0,'unit','2026-01-26 03:16:33',NULL);
INSERT INTO "products" VALUES(51,'Schulke Octenisan Antimicrobial Wash Lotion 500ML','Skincare','recurring',19.0,'L','2026-01-27 15:37:42','2026-W05');
INSERT INTO "products" VALUES(52,'Olaplex No. 4C Bond Maintenance Purifying Shampoo','Hair Care','recurring',50.0,'L','2026-01-27 15:50:32','2026-W05');
...
INSERT INTO "scheduler_runs" VALUES(5,'2026-01-26 23:00:00','2026-01-26 23:00:10','completed',1,1,0,NULL);
INSERT INTO "scheduler_runs" VALUES(6,'2026-01-27 23:00:00','2026-01-27 23:01:09','completed',1,1,0,NULL);
...
INSERT INTO "stores" VALUES(19,'Pact');
INSERT INTO "stores" VALUES(20,'Zalando');
CREATE TABLE tracked_item_labels (
    tracked_item_id INTEGER NOT NULL,
    label_id INTEGER NOT NULL,
    PRIMARY KEY (tracked_item_id, label_id),
    FOREIGN KEY(tracked_item_id) REFERENCES "tracked_items_old"(id) ON DELETE CASCADE,
...
INSERT INTO "tracked_items" VALUES(2,2,1,'https://www.amazon.nl/-/en/BTF-LIGHTING-Flexible-Waterproof-Multicolor-Decoration/dp/B0C3VMV5BP/ref=sr_1_2?crid=4G3PBKIR5ZSJ&dib=eyJ2IjoiMSJ9.40v-SQ54YW-SRJAeIw05m-Hg85YqppMxyUpL1b7Iwsj1H3TtE3Onti_S72Q9luoJ0fNQ4RaiRDbMS28tVM2Kz23BxtxX23SxDRlEa9wK0fARqowRI1lSanbPvHpg2ZsHwx0DFQojXS0BKNRWmkHjk4kCWeCW4mXKwCDPDrAt-KPncb04JogkbA1drNYSYOV4OBL2Z05zTtUOqq-xgF-7LENH50XkBcNq-VYcgbeNWC96ipNmsW0yidnQqCe-mZ5MCTXuPmyTFbdjp-DFNla1_1GS-2tFEf5O4nt9poCYuB8.W9jULAY2bcROfjUbMnwy9YcMvc8Xh9Vtnj_NuAbMHX0&dib_tag=se&keywords=BTF-LIGHTING%2BFCOB%2BRGBCCT%2B(24V%2C%2B960LED%2Fm)&qid=1769001366&sprefix=btf-lighting%2Bfcob%2Brgbcct%2B24v%2B960led%2Fm%2B%2Caps%2C229&sr=8-2&th=1',NULL,1.0,'1',1,'2026-01-24 00:55:59',0,0);
INSERT INTO "tracked_items" VALUES(3,3,1,'https://www.amazon.nl/dp/B09Y5RHJJ7/ref=sspa_dk_detail_3?pd_rd_i=B09Y5RHJJ7&pd_rd_w=RW6Ex&content-id=amzn1.sym.2ecceb92-891b-4f6a-8f2e-861d1c3c6df9&pf_rd_p=2ecceb92-891b-4f6a-8f2e-861d1c3c6df9&pf_rd_r=MNW2N8WHZXA9EWRSWRPQ&pd_rd_wg=tpEcw&pd_rd_r=24f37adc-9301-4644-88c0-95783e071f69&aref=iGaUDsXvlQ&sp_csd=d2lkZ2V0TmFtZT1zcF9kZXRhaWw&th=1',NULL,1.0,'1',1,'2026-01-23 23:00:40',0,0);
INSERT INTO "tracked_items" VALUES(4,4,1,'https://www.amazon.nl/-/en/ZigBee-Controller-DC12-24V-Compatible-Control/dp/B0CXJF6DRM/ref=sr_1_1?crid=CQFNCJCCHHHX&dib=eyJ2IjoiMSJ9.5HMR8hr5boBzpMdf91yhRbDW_bmzSr1uzrlhuXzGs_67jfTFxhDdKihAQXq0_bvvkVZ2BceyDfdsvIdgvlmcyWPOVSI_NByiJOodDN97k-4sFUjn2QYyL0uX0zmZSIGIwpktVHYz8ZGgUH5dookZKpAHH6F8UknMUpu7XW_mrOSuOVHsnEHlYYIhitA_pdx14GW2DiR7vIeCamXhLPk6WV9HbFW7g-OGx4PEFABzdlb3ZMnHGanVaAJ-pfex5iRo27VL7ARoQFMnPkY1BaKJrxC90WZGB6_qB2LDul5zZXg.UzCEKXM89_XpK-aknj4Dnm6de1AkiNUXQGSh6IHbfnE&dib_tag=se&keywords=zigbee+pro%2Bsmart+led+controller+5-in-1+2.4ghz&qid=1769002105&sprefix=zigbee+pro+smart+led+controller+5-in-1+2.4ghz+%2Caps%2C244&sr=8-1',NULL,1.0,'1',1,'2026-01-24 00:55:51',0,0);
INSERT INTO "tracked_items" VALUES(5,5,2,'https://www.bol.com/nl/nl/p/whiskas-1-kattenbrokken-kip-zak-6-x-1-9kg/9200000072257568/?cid=1768770255524-1740561506859&bltgh=tvPN9yKWu3yjWl3bpZ1BNw.4_25.28.ProductImage',NULL,1.0,'1',6,'2026-01-24 00:55:30',0,0);
INSERT INTO "tracked_items" VALUES(11,10,4,'https://www.stradivarius.com/nl/silk-eau-de-toilette-no101--100-ml-l00419056?categoryId=1020208533&colorId=310&style=02&pelement=485588125',NULL,100.0,'ml',1,'2026-01-27 23:45:34',1,1);
INSERT INTO "tracked_items" VALUES(12,11,5,'https://www.douglas.nl/nl/p/5010033070',NULL,30.0,'ml',1,'2026-01-24 00:55:56',0,0);
INSERT INTO "tracked_items" VALUES(13,11,1,'https://www.amazon.nl/-/en/OLAPLEX-No-Bonding-Oil-30/dp/B07ZHKTQL3/ref=sr_1_2?crid=3L5IO4YLCLAJR&dib=eyJ2IjoiMSJ9.U5W0cstTUnY_zz16rAT609WmZucTLAPIGGXSsHS-GXHCAWd60gmq-PmhRZLjer1ogPL5shI7rbfbQVO5kv-S7R37xJZlgxfCpmy0vpMg_7R8ZzCls6jtPBgwkQmqiysGBvTT3kgnD8ixykPxL7Ns0hn09t8RwienoAcaPExJAznwMz52pQec11Qylm3UZVSHhMe9me83mWTR-yvFtZa_bX2SEZcnrGGYEzGelnTsyLrimQUbzMWakdiVNLW6Dm1jSb-qpDBW4DrHvfMPei56RxLEWzBQmq1GxQGWBdXDcH0._QYvjFzXyy4C99JAub2Hbf3iKopnl6Oh8PBVCzq5eBQ&dib_tag=se&keywords=olaplex+oil&qid=1769049809&sprefix=olaplex+%2Caps%2C330&sr=8-2',NULL,30.0,'ml',1,'2026-01-24 00:56:07',0,0);
INSERT INTO "tracked_items" VALUES(20,18,7,'https://www.kruidvat.nl/kruidvat-biologische-psylliumvezels/p/4966221',NULL,120.0,'g',1,'2026-01-24 05:21:36',0,0);
...
INSERT INTO "tracked_items" VALUES(24,11,1,'https://www.amazon.nl/-/en/OLAPLEX-No-Bonding-Oil-30/dp/B07ZHKTQL3?pd_rd_w=skz4Y&content-id=amzn1.sym.d8cc06e3-3f8f-4b61-8fd5-c32f2ba4e8ee&pf_rd_p=d8cc06e3-3f8f-4b61-8fd5-c32f2ba4e8ee&pf_rd_r=G8SV5DC367RBBZ09KSS2&pd_rd_wg=zJDLw&pd_rd_r=df5bad41-2d86-45ec-b383-9b98098a4c38&psc=1&ref_=pd_bap_d_grid_rp_csi_pd_ys_c_rfy_rp_crs_0_pr_t',NULL,30.0,'ml',1,'2026-01-24 23:12:32',0,0);
INSERT INTO "tracked_items" VALUES(25,11,6,'https://www.etos.nl/producten/olaplex-no.-7-bond-oil-30-ml%C2%A0-120799558.html',NULL,30.0,'ml',1,'2026-01-24 23:20:57',0,0);
INSERT INTO "tracked_items" VALUES(26,11,5,'https://www.douglas.nl/nl/p/5010033070',NULL,30.0,'ml',1,'2026-01-25 23:00:30',0,0);
INSERT INTO "tracked_items" VALUES(27,11,7,'https://www.kruidvat.nl/olaplex-no7-bonding-oil/p/mp-00046276',NULL,30.0,'ml',1,'2026-01-24 23:15:04',0,0);
INSERT INTO "tracked_items" VALUES(28,11,7,'https://www.kruidvat.nl/olaplex-no7-bonding-oil/p/mp-00045602',NULL,60.0,'ml',1,'2026-01-24 23:15:33',0,0);
INSERT INTO "tracked_items" VALUES(29,11,7,'https://www.kruidvat.nl/olaplex-5x-no7-bonding-oil-30ml/p/mp-00054926',NULL,30.0,'ml',5,'2026-01-24 23:15:56',0,0);
INSERT INTO "tracked_items" VALUES(30,4,1,'https://www.amazon.nl/-/en/ZigBee-Controller-DC12-24V-Compatible-Control/dp/B0CXJF6DRM/ref=sr_1_1?crid=3KJFSUOFW9KK&dib=eyJ2IjoiMSJ9.7Az3zpxSW3xYEMYzQmVlCUgJDtuPAMTVhy4aovkVQzC7jfTFxhDdKihAQXq0_bvvuWvbGWsmJpZ1BOAwd5wP8AhOWOyZ0pJdrCqTf4C4t5a6eQuEC62gGOt1V0vaRms3HBtu6Hp0YbgiIPaEVG3GW1zdNta20SEGxfZempAfYeEHIeoxX2I6ecea2OE3ZB0F_mpElLk7WVN95YsK9j7S78taU73Ao0rgLqk4M945MtCatpIL0UJZKCniTngmDKYwNunZKYHWFdAG8CDIu78xk_X5r1BzTanTKN9rhH2KNX8.pJHofQ12tn8kgRAF7YSHkHJ1iX7HibYhsc-lpX3zIvU&dib_tag=se&keywords=ZigBee+3.0+Pro%2B+Smart+LED+Controller&qid=1769353809&sprefix=zigbee+3.0+pro+smart+led+controller%2Caps%2C243&sr=8-1',NULL,1.0,'unit',1,'2026-01-25 15:11:38',0,0);
INSERT INTO "tracked_items" VALUES(31,5,2,'https://www.bol.com/nl/nl/p/whiskas-1-kattenbrokken-kip-zak-6-x-1-9kg/9200000072257568/?cid=1768770255524-1740561506859&bltgh=tvPN9yKWu3yjWl3bpZ1BNw.4_25.28.ProductImage',NULL,1.9,'kg',6,'2026-01-25 15:13:30',0,0);
INSERT INTO "tracked_items" VALUES(32,19,1,'https://www.amazon.nl/-/en/916-89702-ACIDIC-BONDING-CONCENTRATE-conditioner/dp/B0C31QQYVL/ref=sr_1_15?crid=2G2LWT0HV2IEY&dib=eyJ2IjoiMSJ9.ZqzK-u2o4rC2tz2rBeC3zJFBnapphKtmXIg7fK7U0axvLAS1bFzwnFd7ittp-oMVznEl4bEJIYqDXOBuhUEbIG0rhc60RbvDWli7ek7FYHvK94VxsfF4AAEqOfoKJ9hbnI1DwNDBSsB7y5E5EvhG9gy_T9trKW4pM--xBxBu8opPW7t4EMPB-tu2MKv4O30-ElLLATCHdqeaGeqI5QrNWwV-o8pMhGH-nHaQr3NiiVTIbZ-Wgk1FCu8e4SALD2J8uz_hDA9M2jT4o86tQhtY-a-7Q6kUeUt4WBdZvGeA3Ks.AJGKCFhfsQpvfc78_ZVkOlJcrngMD7xQeupbs-_WCM8&dib_tag=se&keywords=Redken+Acidic+Bonding+Concentrate+conditioner&qid=1769354336&sprefix=redken+acidic+bonding+concentrate+conditione%2Caps%2C247&sr=8-15',NULL,1.0,'L',1,'2026-01-27 16:45:44',1,1);
INSERT INTO "tracked_items" VALUES(33,20,6,'https://www.etos.nl/producten/loreal-paris-elvive-bond-repair-pre-shampoo-200-ml-120662519.html',NULL,200.0,'ml',1,'2026-01-27 14:16:54',0,0);
INSERT INTO "tracked_items" VALUES(34,20,7,'https://www.kruidvat.nl/loreal-paris-elvive-bond-repair-rescue-pre-shampoo/p/5786583',NULL,200.0,'ml',1,'2026-01-27 23:01:09',1,1);
INSERT INTO "tracked_items" VALUES(35,21,1,'https://www.amazon.nl/-/en/REDKEN-Acidic-Bonding-Concentrate-Shampoo/dp/B093QNKSYR/ref=pd_bxgy_d_sccl_1/260-1856934-5132330?pd_rd_w=5uDZy&content-id=amzn1.sym.f55d1bfa-6e70-4525-8a1e-d27f38476426&pf_rd_p=f55d1bfa-6e70-4525-8a1e-d27f38476426&pf_rd_r=JCXHMAPQWYV6JP5TJZSB&pd_rd_wg=hEwbq&pd_rd_r=46f5e312-c293-4f76-a698-d15ab20bd67b&pd_rd_i=B093QNKSYR&psc=1',NULL,1.0,'L',1,'2026-01-26 23:07:17',0,0);
INSERT INTO "tracked_items" VALUES(36,29,6,'https://www.etos.nl/producten/cerave-schuimende-reinigingsgel-976-ml-120599556.html',NULL,976.0,'ml',1,'2026-01-25 17:44:19',0,0);
INSERT INTO "tracked_items" VALUES(37,29,6,'https://www.etos.nl/producten/cerave-schuimende-reinigingsgel-navulling-473-ml-120850931.html',NULL,473.0,'ml',1,'2026-01-25 17:18:30',0,0);
INSERT INTO "tracked_items" VALUES(38,29,1,'https://www.amazon.nl/-/en/Cerave-Moisturizing-Cleansing-Foam-1l/dp/B07HF991NV/ref=sr_1_1?crid=27345PXLH8UFV&dib=eyJ2IjoiMSJ9.25cFludDdSedIn9rU8Kttm2NGT1hEv-WfRrRxylpBOxfH3kXlEoAKwg-JFmT4L6IqRVRfUxanEY1uL_9__4lnM9sK_xcMlhaj1Go_9lx5W9p84t3bQ318x5ehGwvZh7qNqyJxwmKU4kZXZKSFZDGEma3PRlsaRC1IbIGgdcbUwdtG333gAMPTt5woXkK9pQI1AUWthldiXGxKj6xIHPAQRSoncVkw6Ew1l2ZF2diPtQLiufAFF809KkIh1iAz1tYajd4V3Y9to86d1lvGGy9rMo9Wmtv9wCrsNCws-zCqCc.rKXuS6CYv0o8ZdlePhzWgE6M8VTismUwWDTcQDEFWgo&dib_tag=se&keywords=CeraVe%2BFoaming%2BCleansing%2BGel&qid=1769360669&sprefix=cerave%2Bfoaming%2Bcleansing%2Bgel%2Caps%2C318&sr=8-1&th=1',NULL,976.0,'ml',1,'2026-01-25 23:00:38',0,0);
INSERT INTO "tracked_items" VALUES(39,31,9,'https://www.intertoys.nl/lego-botanicals-madeliefjes-11508',NULL,1.0,'unit',1,'2026-01-25 17:57:55',0,0);
INSERT INTO "tracked_items" VALUES(40,31,1,'https://www.amazon.nl/-/en/LEGO-Botanicals-Daisies-Artificial-Decoration/dp/B0FPXDY3X2/ref=pd_bxgy_d_sccl_1/260-1856934-5132330?pd_rd_w=OYdup&content-id=amzn1.sym.75142c34-87ae-4c36-8448-6beafeb35427&pf_rd_p=75142c34-87ae-4c36-8448-6beafeb35427&pf_rd_r=8KJ8VYFM9K2CF5MNBJ29&pd_rd_wg=9DuqP&pd_rd_r=d60108d7-aa92-446d-9e7d-4020d765d07a&pd_rd_i=B0FPXDY3X2&psc=1',NULL,1.0,'unit',1,NULL,0,0);
INSERT INTO "tracked_items" VALUES(45,33,10,'https://www.levi.com/NL/nl_NL/kleding/dames/jeans/xl-lightweight-overall/p/001V00000','M',1.0,'unit',1,'2026-01-26 23:41:52',0,0);
INSERT INTO "tracked_items" VALUES(46,33,20,'https://www.zalando.nl/levis-overall-tuinbroek-invested-indigo-le221t02g-k12.html','M',1.0,'unit',1,'2026-01-27 14:13:10',0,0);
INSERT INTO "tracked_items" VALUES(47,51,1,'https://www.amazon.nl/-/en/gp/product/B0036IKUTE/ref=ox_sc_act_title_3?smid=AW7QLILMW1NRG&psc=1',NULL,500.0,'ml',1,'2026-01-27 15:38:19',1,1);
INSERT INTO "tracked_items" VALUES(48,52,1,'https://www.amazon.nl/-/en/gp/product/B0B4SP2CK4/ref=ox_sc_act_title_5?smid=A17D2BRD4YMT0X&psc=1',NULL,250.0,'ml',1,'2026-01-27 15:50:57',1,1);
CREATE TABLE units (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    name TEXT NOT NULL UNIQUE
);
...
INSERT INTO "sqlite_sequence" VALUES('api_usage',115);
INSERT INTO "sqlite_sequence" VALUES('price_history',122);
INSERT INTO "sqlite_sequence" VALUES('extraction_logs',139);
INSERT INTO "sqlite_sequence" VALUES('scheduler_runs',6);
INSERT INTO "sqlite_sequence" VALUES('categories',178);
INSERT INTO "sqlite_sequence" VALUES('labels',151);
INSERT INTO "sqlite_sequence" VALUES('error_log',12);
INSERT INTO "sqlite_sequence" VALUES('purchase_types',2);
INSERT INTO "sqlite_sequence" VALUES('units',21);
INSERT INTO "sqlite_sequence" VALUES('products',52);
INSERT INTO "sqlite_sequence" VALUES('stores',20);
INSERT INTO "sqlite_sequence" VALUES('tracked_items',48);
COMMIT;
